...
This project is under the MIT license. See the [LICENSE](https://github.com/codekalimi/The-Crown-Online-Luxuries-Shopping-Application/blob/master/client/LICENSE) for more information.

Made with ♥ by Franciane Póvoa :wave: [Get in touch!](https://github.com/codekalimi) 